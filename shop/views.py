...
def product_list(request, category_slug=None):
	...
	if category_slug:
		category = get_object_or_404(Category, translations__slug=category_slug)
...
def product_detail(request, product_id, product_slug):
	...
	product = get_object_or_404(Product, id=product_id, translations__slug=product_slug, available=True)
	r = Recommender()
